...
const Left = (props) => {
  ...
  return (
    <div className=' p-5 w-2/5 flex flex-col bg-amber-50 gap-5'>
        ...
        <button onClick={postData} className='border border-amber-300 bg-red-400 py-3 px-4 text-center font-semibold text-white text-md rounded-md active:scale-95'>Submit</button>
    </div>
  )
}
